  ...
  var resLib = {
    ...
    loadGame() {
      return __async(this, null, function* () {
        ...
        const atlases = [
          ["./img/a0.{webp,png}.f342fa21c4.json","./img/a1.{webp,png}.5f25c3d151.json","./img/a2.{webp,png}.affb7af63d.json","./img/a3.{webp,png}.178d417173.json","./img/a4.{webp,png}.cfbffa7ac4.json","./img/a5.{webp,png}.4a3e6b3d50.json","./img/a6.{webp,png}.12e455295f.json","./img/a7.{webp,png}.a19e7900ac.json"]
        ][0];
        const tiledImages = [
          {}
        ][0];
...
{
if(this.position.y < 290 && !rooms.current.win)
{
...
{
if(this.position.y < 300 && !rooms.current.win)
{
    rooms.current.timer1 = 0;
    rooms.current.win = true;
    rooms.current.timerLabel.text = '00:00';
...
rooms.templates['Detailer'] = {
    ...
    height: 1280,
    behaviors: JSON.parse('[]'),
    objects: JSON.parse('[{"x":360,"y":640,"opacity":1,"tint":16777215,"scale":{"x":0.2285,"y":0.2285},"rotation":0,"exts":{},"customProperties":{},"template":"CutBG"},{"x":363,"y":708,"opacity":1,"tint":16777215,"scale":{"x":0.22855,"y":0.22855},"rotation":0,"exts":{},"customProperties":{},"template":"Lightbox"},{"x":360,"y":96,"opacity":1,"tint":16777215,"scale":{"x":1,"y":1},"rotation":0,"exts":{},"customProperties":{},"template":"Logo"},{"x":683.5625,"y":0,"opacity":0,"tint":16777215,"scale":{"x":1.31933594,"y":19},"rotation":0,"exts":{},"customProperties":{},"template":"Black"},{"x":-10.1875,"y":-97.5,"opacity":0,"tint":16777215,"scale":{"x":11.35253906,"y":4.8828125},"rotation":0,"exts":{},"customProperties":{},"template":"Black"},{"x":-64,"y":0,"opacity":0,"tint":16777215,"scale":{"x":1.67089844,"y":19},"rotation":0,"exts":{},"customProperties":{},"template":"Black"},{"x":-64,"y":1204.0625,"opacity":0,"tint":16777215,"scale":{"x":13,"y":3.18652344},"rotation":0,"exts":{},"customProperties":{},"template":"Black"}]'),
    bgs: JSON.parse('[]'),
    tiles: JSON.parse('[]'),
    backgroundColor: '#212121',
...
rooms.templates['Try Again'] = {
    ...
    height: 1280,
    behaviors: JSON.parse('[]'),
    objects: JSON.parse('[{"x":-96.8125,"y":-64,"opacity":0.9,"scale":{"x":14,"y":23},"rotation":0,"exts":{},"customProperties":{"newProperty1":"","newProperty2":""},"template":"Placeholder"}]'),
    bgs: JSON.parse('[]'),
    tiles: JSON.parse('[]'),
    backgroundColor: '#212121',
